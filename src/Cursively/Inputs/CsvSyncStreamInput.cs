...
{
    /// <summary>
    /// Implementation of <see cref="CsvSyncInputBase"/> backed by a <see cref="Stream"/>.
    /// </summary>
    public sealed class CsvSyncStreamInput : CsvSyncInputBase
    {
        ...
        /// </param>
        /// <returns>
        /// A new instance of the <see cref="CsvSyncStreamInput"/> class as a copy of this one, with
        /// the given delimiter.
        /// </returns>
